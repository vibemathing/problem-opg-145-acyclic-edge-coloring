...
```json
{
  ...
  "problem_contract": {
    ...
    "definitions": [
      {
        "definition": "Incident edges receive distinct colors.",
        "term": "proper edge coloring"
      },
      {
        "definition": "A proper edge coloring with no cycle whose edges use only two colors.",
        "term": "acyclic edge coloring"
      },
      {
    ...
    "domain": {
      "description": "Finite simple graphs with maximum degree Δ.",
      "objects": [
    ...
    "problem_id": "problem:opg-145-acyclic-edge-coloring",
    "quantifiers": [
      {
      ...
      {
        "domain": "proper edge colorings of G using at most Δ(G)+2 colors and with no bichromatic cycle",
        "kind": "exists",
        "variables": [
          "c"
        ]
    ...
    "sources": [
      {
        ...
        "source": "UnsolvedMath",
        "source_record_id": "unsolvedmath-opg-145-78c00ea9e9b0",
        "url": "https://www.unsolvedmath.com/problems/OPG-145"
      },
      {
    ...
    "statement": {
      "language": "en",
      "text": "Does every finite simple graph G of maximum degree Δ admit a proper edge coloring with at most Δ+2 colors such that every cycle uses at least three distinct colors?",
      "version": 1
    },
    "title": "Acyclic edge-coloring",
    "updated_at": "2026-09-06T04:47:54Z"
  },
  "problem_contract_sha256": "1036a59ee6a6edec2bad7e36990280a5ef127704f5b0cefd97e354494c7e8fca"
}
```
